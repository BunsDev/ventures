      ...
      <div className={ classes.root }>
        <div className={ classes.headerV2 }>
          <div className={ classes.icon }>
            <img
              alt=""
              src={ require('../../assets/GDAO-logo.png') }
              height={ '40px' }
              onClick={ () => { this.nav('') } }
            />
            <Typography variant={ 'h3'} className={ classes.name } onClick={ () => { this.nav('') } }>Governor DAO</Typography>
          </div>
          <div className={ classes.links }>
            { this.renderMenuLinks({ label: 'governate', screens: ['governate'] }) }
          </div>
